    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(Icons.today), title: Text("项目")),
          BottomNavigationBarItem(icon: Icon(Icons.today), title: Text("记录")),
          BottomNavigationBarItem(
              icon: Icon(Icons.multiline_chart), title: Text("图表")),
